...
class BasePage:
    ...
    def switch_tenant(self,tenant):
        ...
        if tenant in self.hover_top_menu.text_content():
            logger.info("要切换的租户和当前页面租户相同，则无须切换")
            return
    ...
    def switch_view(self,view):
        ...
        logger.info("当前租户为{0}".format(current_tenant))
